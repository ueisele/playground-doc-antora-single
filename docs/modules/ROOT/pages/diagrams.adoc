...
In this example the xref:diagrams/extensions/plantuml.adoc[PlantUML] extension is used in favour of xref:diagrams/extensions/kroki.adoc[Kroki], because PlantUML is also upported by GitLab.

== Diagram Types

Diagram types, which are rendered with link:https://plantuml.com/en/[PlantUML]:
